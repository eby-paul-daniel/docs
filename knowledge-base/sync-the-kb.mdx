...
4. Click **+ Create New**.
5. In the **Input** section:<br/>![Crawler Input](/img/knowledge-base/knowledge-base/crawler-input.png)
...
6. In the **Crawler Settings** section:<br/>![Crawler Settings](/img/knowledge-base/knowledge-base/crawler-settings.png)
...
7. In the **Scheduling** section, define the frequency and time for scheduled crawls:<br/>![Crawler Scheduling](/img/knowledge-base/knowledge-base/crawler-scheduling.png)
