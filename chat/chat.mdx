...
### Chat Debug Panel 
* **Document Context Results** – This tab shows the retrieved Knowledge Base results the agent used to generate its response, including the source name, content snippet, and relevance score. If no relevant information was found, it will state "No results found."<br/>
![Document Context Results](/img/chat/document_context_results.png)
