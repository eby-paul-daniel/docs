...
![Exporting a workflow](/img/tools/export.png)
...
The a JSON file will be automatically created and downloaded to your Downloads directory with the name of the workflow as the filename, e.g., "_My Workflow.json_"
...
![Importing a workflow](/img/tools/import.png)

<Warning>
  The EKB application where the exported workflow came from must be the same
  version as the EKB you intend to import the workflow into.
</Warning>
