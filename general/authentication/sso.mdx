...
<Info>
Odin AI's support team handles SSO configuration and testing. You only need to configure your identity provider and provide the necessary details (metadata URL, domain, and provider) to [Support](mailto:support@getodin.ai).
</Info>
